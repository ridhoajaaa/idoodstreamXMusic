...
from idoodstreamXMedia.core.dir import COUPLE_DIR
from idoodstreamXMedia.mongo.couples_db import get_couple, save_couple


ASSETS = Path("idoodstreamXMedia/assets")
...
async def generate_image(chat_id: int, uid1: int, uid2: int, date: str) -> str:
    base = Image.open(ASSETS / "idoodstream/couple.png").convert("RGBA")
