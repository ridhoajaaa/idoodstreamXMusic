...
from idoodstreamXMedia.misc import HAPP, SUDOERS, XCB
from idoodstreamXMedia.utils.database import (
    get_active_chats,
    remove_active_chat,
    remove_active_video_chat,
)
from idoodstreamXMedia.utils.decorators.language import language
...
async def update_(client, message, _):
    ...
    if len(_final_updates_) > 4096:
        url = await idoodstreamBIN(updates)
    ...
    if await is_heroku():
        ...
        os.execv(sys.executable, [sys.executable, "-m", "idoodstreamXMedia"])
