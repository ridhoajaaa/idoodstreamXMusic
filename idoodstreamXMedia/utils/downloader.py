...
from idoodstreamXMedia.core.dir import CACHE_DIR, DOWNLOAD_DIR
from idoodstreamXMedia.utils.cookie_handler import COOKIE_PATH as _COOKIES_FILE
from idoodstreamXMedia.utils.tuning import CHUNK_SIZE, SEM
    ...
    if type == "audio":
        ...
        async def run():
            ytdlp_task = asyncio.create_task(
                run_with_semaphore(
                    loop.run_in_executor(None, download_with_ytdlp_sync, link, "251/140/bestaudio[vcodec=none]/bestaudio")
                )
            )
