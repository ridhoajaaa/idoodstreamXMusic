...
<div align="center">
  <table>
    <tr>
      ...
      <td>
        <img src="https://readme-typing-svg.herokuapp.com?color=00BFFF&width=600&lines=Hey+There,+This+is+idoodstream+%F0%9F%A5%80+%E2%9D%97%EF%B8%8F" />
      </td>
    </tr>
  </table>
</div>
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=idoodstreams&style=flat-square" />
</p>

<h1 align="center">
  <img src="https://readme-typing-svg.herokuapp.com?color=FF69B4&width=500&lines=Welcome+to+idoodstream+%F0%9F%8E%B6+The+Robot;Your+Ultimate+Telegram+Music+Bot" />
</h1>

<p align="center">
  <a href="https://t.me/idoodstreams">
    <img src="https://files.catbox.moe/eh780q.jpg" width="600">
  </a>
</p>

<p align="center">
  <a href="https://t.me/idoodstreamXRobot"><img src="https://img.shields.io/badge/Try%20Bot-@idoodstreamXRobot-blue?style=for-the-badge&logo=telegram"/></a>
</p>


<p align="center">
  <a href="https://github.com/idoodstreams/idoodstreamXMusic/stargazers"><img src="https://img.shields.io/github/stars/idoodstreams/idoodstreamXMusic?style=flat-square"/></a>
  <a href="https://github.com/idoodstreams/idoodstreamXMusic/network/members"><img src="https://img.shields.io/github/forks/idoodstreams/idoodstreamXMusic?style=flat-square"/></a>
  <a href="https://github.com/idoodstreams/idoodstreamXMusic/issues"><img src="https://img.shields.io/github/issues/idoodstreams/idoodstreamXMusic?style=flat-square"/></a>
  <a href="https://github.com/idoodstreams/idoodstreamXMusic/commits/main"><img src="https://img.shields.io/github/last-commit/idoodstreams/idoodstreamXMusic?style=flat-square"/></a>
  <a href="https://github.com/idoodstreams/idoodstreamXMusic/actions"><img src="https://img.shields.io/badge/CI-Status-grey?style=flat-square"/></a>
</p>

## 🌟 What is idoodstreamXMusic?

**idoodstreamXMusic** is a modern Telegram bot that streams **high-quality music** into group voice chats.
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          3) Get ID via <code>@idoodstreamXRobot</code> or <code>@MissRose_Bot</code>
        </td>
...
```bash
🎵 Deploy idoodstreamXMusic on VPS
...
# Step 3: Clone & Setup
git clone https://github.com/idoodstreams/idoodstreamXMusic
cd idoodstreamXMusic
tmux new -s idoodstream
...
tmux attach-session -t idoodstream       # Reattach session
tmux kill-session -t idoodstream         # Kill bot session
rm -rf idoodstreamXMusic                # Uninstall bot
```
...
### Step 3: Build Image
docker build -t idoodstreamxmusic .

### Step 4: Run Container
docker run -d --name idoodstream --env-file .env --restart unless-stopped idoodstreamXMusic

### Step 5: Manage Container
docker logs -f idoodstream        # View logs (Ctrl+C to exit)
docker stop idoodstream           # Stop container
docker start idoodstream          # Start again
docker rm -f idoodstream          # Remove container
docker rmi idoodstreamxmusic      # Remove image
```
...
| 🌍 **Heroku Deploy**    | <a href="http://dashboard.heroku.com/new?template=https://github.com/idoodstreams/idoodstreamXMusic"><img src="https://img.shields.io/badge/Deploy%20to-Heroku-purple?style=for-the-badge&logo=heroku"/></a> |
...
* <b> *ᴄʀᴀғᴛᴇᴅ ᴡɪᴛʜ ᴘᴀssɪᴏɴ ʙʏ <a href="https://github.com/idoodstreams">ᴄᴇʀᴛɪғɪᴇᴅ ᴄᴏᴅᴇʀs</a>* </b>